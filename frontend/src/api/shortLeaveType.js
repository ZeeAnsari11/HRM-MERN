...
export const createShortLeaveType = (formData, changeToggler, trigger) => {
  axios
    .post(shortLeaveTypeRoute.createShortLeaveType, formData)
    .then(() => {
...
export const getShortLeaveTypeByOrgId = (
  orgId,
  setLeaveType,
  trigger = null
) => {
...
export const updateShortLeaveTypeById = (id, formData, trigger) => {
  axios
    .put(shortLeaveTypeRoute.updatShorteLeaveTypeById + id, formData)
    .then((response) => {
