      ...
      <div className="relative w-full mt-12 lg:w-1/2 lg:mt-0">
        ...
        <div className="wf-ull lg:w-1/2">
          ...
          <div className="flex items-center mt-6 gap-x-3">
            <Link to='/login' className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600">
              Take me home
            </Link>
          </div>
        </div>
